...
# Partition sizes (примерные значения для M13 - подставь свои!)
BOARD_BOOTIMAGE_PARTITION_SIZE := 67108864
BOARD_RECOVERYIMAGE_PARTITION_SIZE := 67108864
BOARD_SYSTEMIMAGE_PARTITION_SIZE := 4144037888      # ~3.86 GiB
BOARD_VENDORIMAGE_PARTITION_SIZE := 1073741824
BOARD_PRODUCTIMAGE_PARTITION_SIZE := 536870912
BOARD_CACHEIMAGE_PARTITION_SIZE := 202379264        # ~193 MiB
BOARD_USERDATAIMAGE_PARTITION_SIZE := 54547095552   # ~50.82 GiB
BOARD_FLASH_BLOCK_SIZE := 4096

# File system types (ПРАВИЛЬНЫЕ для M13!)
BOARD_HAS_LARGE_FILESYSTEM := true
TARGET_USERIMAGES_USE_EXT4 := true
TARGET_USERIMAGES_USE_F2FS := true
TARGET_USERIMAGES_SPARSE_EXT_DISABLED := false

# File system for each partition
BOARD_BOOTIMAGE_FILE_SYSTEM_TYPE := ext4
BOARD_RECOVERYIMAGE_FILE_SYSTEM_TYPE := ext4
BOARD_SYSTEMIMAGE_FILE_SYSTEM_TYPE := f2fs          # ← F2FS, не ext4!
BOARD_VENDORIMAGE_FILE_SYSTEM_TYPE := ext4
BOARD_PRODUCTIMAGE_FILE_SYSTEM_TYPE := ext4         # или f2fs, если product тоже f2fs
BOARD_CACHEIMAGE_FILE_SYSTEM_TYPE := ext4           # ← ext4 (как на скриншоте)
BOARD_USERDATAIMAGE_FILE_SYSTEM_TYPE := f2fs        # ← F2FS (как на скриншоте)

# Copy targets
TARGET_COPY_OUT_SYSTEM := system
TARGET_COPY_OUT_VENDOR := vendor
TARGET_COPY_OUT_PRODUCT := product
TARGET_COPY_OUT_CACHE := cache
